...
export const button = (): React.ReactElement => {
  const label = text('childen', 'BUTTON');
...
export const tertiaryButton = (): React.ReactElement => {
...
export const customSized = (): React.ReactElement => {
  return (
    <div css={buttonWrapper}>
      <div>
...
export const iconOnly = (): React.ReactElement => {
  return (
    <div>
      <ButtonGroup>
